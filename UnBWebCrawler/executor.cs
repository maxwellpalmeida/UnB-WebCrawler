                ...
                foreach (var bucket in Interleaved(this.Departments))
                {
                    ...
                    foreach (var discipline in department.Disciplines)
                    {
                        foreach (var teachClass in discipline.TeachClasses)
                        {
                            ...
                            workSheet.Cells[aux, "J"] = teachClass.getClassShift();
                            workSheet.Cells[aux, "K"] = teachClass.getFirstSchedule();
                            workSheet.Cells[aux, "L"] = teachClass.getAllOthersSchedules();
                            workSheet.Cells[aux, "M"] = teachClass.getLocations();
